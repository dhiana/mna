...
./bin/mna data/bennetmult3.net
./bin/mna data/chuapole.net
...
./bin/mna data/mult.net
./bin/mna data/prova.net
./bin/mna data/teslak.net
./bin/mna data/tracpol.net
./bin/mna data/tractran.net
./bin/mna data/tunel3.net
